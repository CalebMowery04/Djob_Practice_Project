...
<template>
    <div class="py-10 px-6 grid md:grid-cols-4 gap-3">
        <div class="md:col-span-3">
            ...
            <a v-bind:href="'mailto:' + job.company_email" class="inline-block mt-6 py-4 px-8 bg-teal-700 text-white rounded-xl">Apply</a>
        </div>
        ...
        <div class="md: col-span-1 p-6 bg-teal-700 text-white rounded-xl">
            ...
            <p class="">Posted at {{ job.created_at_formatted }}</p>
